...
| 0apr2 | 🔴 Critical | **⚠️ DEADLINE: 22 DAYS — GitHub Copilot training opt-out expires April 24** — HN thread (April 2, top of front page): "If you don't opt out by Apr 24 GitHub will train on your private repos"; GitHub community discussion #188488 active with hundreds of replies; opt-out URL: github.com/settings/copilot/features; GitHub blog FAQ published but community anger not subsiding — description "your preference has been retained if you previously opted out" is seen as deflecting from the NEW default-opt-in policy change; devs with private repositories, client code, and proprietary business logic urgently warned to act; EU GDPR implications being debated (GitHub claims adequate safeguards; EU-based users disputing this) | GitHub Copilot (Microsoft) | **⚠️ DEADLINE APRIL 24** — opt out now |
